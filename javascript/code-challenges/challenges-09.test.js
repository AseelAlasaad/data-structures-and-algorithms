...
const maxInArray = (arr) => {
  ...
  let maxValue=arr.reduce((acc,val,idx)=>{
...
const getCourseKeys = (obj) => {
  // Solution code here...
  let keysArr=Object.keys(courseInfo);
  return keysArr;
...
Write a function named checkValues
 that takes in an object and a value and returns true if the value is in the object.
...
Write a function named hasChildrenValues
 that uses Object.values to determine if any given character in the data set has children.
