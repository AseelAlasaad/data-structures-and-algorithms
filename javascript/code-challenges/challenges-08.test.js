...
Use the characters data below for 
all of the challenges except challenge 2 and 3.
...
Write a function named isNum that takes
 ...
 This function should use a regular 
 expression pattern to return true if 
 the input contains a number, and false if the 
...
const isNum = (input) => {
  // Solution code here...
  let regex=/\d/;
  let testInput=regex.test(input);
  return testInput;
};
...
Write a function named containsWorld 
that takes in a string or number of any length. 
This function should use a regular expression pattern 
to return true if the input contains the word 'world'
...
Write a function named isCapitalized that
 takes in a string. 
 This function should use a regular expression pattern 
...
Write a function named citiesAtoJ 
that takes in an array of city names 
and uses a regular expression pattern 
to return a new array containing any cities
