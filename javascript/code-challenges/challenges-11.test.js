...
Write a function named transformToLis that,
 given an object, returns an array of the key value pairs as html list items.
...
const divisibleByFiveTwoToThePower = (input) => {
  ...
  input.map(item=>{
    ...
    newArr.push(firstArr.filter(num=>
...
let findShortest = (data) => {
  // Solution code here...
  let nameOfshorth=data.reduce((acc,val)=>{
