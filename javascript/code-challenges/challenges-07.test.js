...
Write a function named removeThree that 
takes an index and an array. The function
 should removes three items in the array starting with the value at the index. 
------------------------------------------------------------------------------------------------ */
...
array and joins all of the elements together in one string on a space.
------------------------------------------------------------------------------------------------ */
...
const listFoods = (recipe) => {
  ...
  result=recipe.ingredients.map(item=>{
   newArr1=item.slice(item.indexOf(' ')+1); //output:'medium-sized Gruffalo'
   newArr2=newArr1.slice(newArr1.indexOf(' ')+1); //output: 'Gruffalo'
   return newArr2; 
  })
