...
given an array as input, uses filter to return an array containing only the numbers.
...
oddValues that,
 given an array of integers as input, uses filter to return an array containing only the odd integers.
